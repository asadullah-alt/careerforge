...
export function MiniResumePreview({ name, type, createdAt, className }: MiniResumePreviewProps) {
    ...
    <div className={cn(
      ...
      <div className="relative h-full p-4 flex flex-col">
        ...
        <div className="flex-1 space-y-4">
          <div className="flex justify-center gap-2">{[...Array(3)].map((_, i) => <div key={i} className="h-1 rounded-full bg-gray-200 w-12" />)}</div>
          ...
          <div className="space-y-1">
            ...
            {[...Array(2)].map((_, groupIndex) => (
              <div key={groupIndex} className="py-1 space-y-1">
          ...
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap gap-2">{[...Array(4)].map((_, i) => <div key={i} className="h-1 rounded-full bg-gray-200 w-16" />)}</div>
          </div>
        </div>
