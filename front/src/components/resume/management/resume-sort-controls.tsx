...
export function ResumeSortControls({ sortParam = 'sort', directionParam = 'direction', currentSort: propCurrentSort, currentDirection: propCurrentDirection }: ResumeSortControlsProps) {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          {sortOptions.map((option) => (
            <DropdownMenuItem key={option.value} onClick={() => handleSortChange(option.value as SortOption)}>
